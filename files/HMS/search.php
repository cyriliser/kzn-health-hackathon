...
<html>
  ...
  <?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($con, "SELECT * FROM patient
            WHERE (`Id_No` LIKE '%".$query."%') OR (`PatientNo` LIKE '%".$query."%')") or die(mysql_error());
        ...
        echo "Identity or Patient Number is incomplete";
    }
?>
