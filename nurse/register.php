...
include_once("resource/db.php");
    ...
    if(isset($_POST['submit'])){
        ...
        $hospital = mysqli_real_escape_string($con, $_POST['hospital_name']);
        $patient_no = mysqli_real_escape_string($con, $_POST['patient_number']);
       ...
       // $fileUpload = mysqli_real_escape_string($con, $_POST['file']);
       ...
       move_uploaded_file($_FILES["file"]["tmp_name"],"uploads/pdf/" . $_FILES["file"]["name"]);
        ...
        //  $sql=mysqli_query($con,"INSERT INTO `patient`(`Pdf_file`)VALUES($upload_pdf')");
        //  if($sql){
